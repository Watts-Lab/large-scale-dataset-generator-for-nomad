		...
		Object[][] scheduleCandidates = {
				...
				{ "STAT6",
						new LogSchedule(0, STEPS_PER_DAY, "STAT6",
								(Supplier & Serializable) () -> model.getQuantitiesOfInterest(), runData5, 1) },
				// EVENT Journal
		{ "EVT1", new LogSchedule(0, "EVT1",
				(Supplier & Serializable) () -> "step,agentId,travelStartTime,travelStartPlaceType,travelStartLocationId,travelEndTime,travelEndLocationId,travelEndPlaceType,intendedTravelEndLocationId,intendedTravelEndPlaceType,purpose,checkInTime,checkOutTime,minPeopleAtPlace,maxPeopleAtPlace,moneyBalanceBefore,moneyBalanceAfter,venueGeometry,venueType,eventDetails,participantIds,eventOtherDetails",
				textFormatter, 0) },
