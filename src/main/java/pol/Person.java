...
public class Person implements Steppable {
	...
	public Workplace getWorkplace() {
		Job currentJob = this.financialSafetyNeed.getJob();
		return currentJob == null ? null : currentJob.getWorkplace();
	}
	...
	private void writeJournalToFile(JournalRecord journal) {
		String line = model.schedule.getSteps() + "," +
				...
				(journal.getVenueGeometry() != null ? journal.getVenueGeometry() : "") + "," +
				(journal.getVenueType() != null ? journal.getVenueType() : "") + ",";
