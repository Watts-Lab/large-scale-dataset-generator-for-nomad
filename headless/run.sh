...
java -Dlog4j2.configurationFactory=pol.log.CustomConfigurationFactory -Dlog.rootDirectory=data -Dsimulation.test=all -jar ../jar/pol.jar -configuration "$MERGED_CONFIG" -until 2880
python3 /Users/krvenkat/Dropbox/nomad/datagen/src/main/python/code/data_generation/integrate.py /Users/krvenkat/Dropbox/nomad/datagen/headless/data/logs AgentStateTable /Users/krvenkat/Dropbox/nomad/datagen/headless/data/logs/trajectories.tsv
